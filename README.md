...
# Installation
To install libarchive, build instructions can be found at https://github.com/libarchive/libarchive/wiki/BuildInstructions.
If you are using ubuntu pre-requisites can be installed with the build-essential meta-package `apt-get install build-essential`.
# License
